...
public class SplitAveragePipeline extends OpenCvPipeline {
    ...
    private Mat zone1 = new Mat();
    private Mat zone2 = new Mat();
    private Mat zone3 = new Mat();
    ...
    public Mat processFrame(Mat input) {
        ...
        zone1 = input.submat(new Rect(0, 150, 237, 150));
        zone2 = input.submat(new Rect(237, 150, 326, 150));
        zone3 = input.submat(new Rect(563, 150, 237, 150));

//         zone1 = input.submat(new Rect(0, 0, line1x, CAMERA_HEIGHT));
//         zone2 = input.submat(new Rect(line1x, 0, line2x - line1x, CAMERA_HEIGHT));
//         zone3 = input.submat(new Rect(line2x, 0, CAMERA_WIDTH - line2x, CAMERA_HEIGHT));
